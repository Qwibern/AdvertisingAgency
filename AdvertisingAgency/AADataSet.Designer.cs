...
namespace AdvertisingAgency {
    ...
    public partial class AADataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Фамилия, string Имя, string Отчество, int Возраст, string Адрес, string НомерТел, string ЭлПочта) {
        ...
        public partial class EmployeeRow : global::System.Data.DataRow {
            ...
            public int Возраст {
                get {
                    return ((int)(this[this.tableEmployee.ВозрастColumn]));
                }
                set {
                    this[this.tableEmployee.ВозрастColumn] = value;
                }
            }
            ...
            public string Адрес {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Адрес\' в таблице \'Employee\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string НомерТел {
                get {
                    return ((string)(this[this.tableEmployee.НомерТелColumn]));
                }
                set {
                    this[this.tableEmployee.НомерТелColumn] = value;
                }
            }
            ...
            public string ЭлПочта {
                get {
                    try {
                        return ((string)(this[this.tableEmployee.ЭлПочтаColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'ЭлПочта\' в таблице \'Employee\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployee.ЭлПочтаColumn] = value;
                }
            }
            ...
            public bool IsАдресNull() {
                return this.IsNull(this.tableEmployee.АдресColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetАдресNull() {
                this[this.tableEmployee.АдресColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsЭлПочтаNull() {
                return this.IsNull(this.tableEmployee.ЭлПочтаColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetЭлПочтаNull() {
                this[this.tableEmployee.ЭлПочтаColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace AdvertisingAgency.AADataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([Фамилия] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ([Возраст] = @Original_Возраст) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)) AND ([НомерТел] = @Original_НомерТел) AND ((@IsNull_ЭлПочта = 1 AND [ЭлПочта] IS NULL) OR ([ЭлПочта] = @Original_ЭлПочта)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([Фамилия], [Имя], [Отчество], [Возраст], [Адрес], [НомерТел], [ЭлПочта]) VALUES (@Фамилия, @Имя, @Отчество, @Возраст, @Адрес, @НомерТел, @ЭлПочта);
SELECT Id, Фамилия, Имя, Отчество, Возраст, Адрес, НомерТел, ЭлПочта FROM Employee WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Фамилия] = @Фамилия, [Имя] = @Имя, [Отчество] = @Отчество, [Возраст] = @Возраст, [Адрес] = @Адрес, [НомерТел] = @НомерТел, [ЭлПочта] = @ЭлПочта WHERE (([Id] = @Original_Id) AND ([Фамилия] = @Original_Фамилия) AND ([Имя] = @Original_Имя) AND ((@IsNull_Отчество = 1 AND [Отчество] IS NULL) OR ([Отчество] = @Original_Отчество)) AND ([Возраст] = @Original_Возраст) AND ((@IsNull_Адрес = 1 AND [Адрес] IS NULL) OR ([Адрес] = @Original_Адрес)) AND ([НомерТел] = @Original_НомерТел) AND ((@IsNull_ЭлПочта = 1 AND [ЭлПочта] IS NULL) OR ([ЭлПочта] = @Original_ЭлПочта)));
SELECT Id, Фамилия, Имя, Отчество, Возраст, Адрес, НомерТел, ЭлПочта FROM Employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Фамилия, Имя, Отчество, Возраст, Адрес, НомерТел, ЭлПочта FROM dbo.Emp" +
                "loyee";
        ...
        public virtual int Fill(AADataSet.EmployeeDataTable dataTable) {
        ...
        public virtual AADataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AADataSet.EmployeeDataTable dataTable = new AADataSet.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AADataSet.EmployeeDataTable dataTable) {
